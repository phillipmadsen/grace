...
<!--expand your reach parallax =================================================== -->
     ...
     {{--           -------------------------------------
               <div class="section parallax full-screen nomargin noborder" style="height: 909px; background-image: {!! url('frontend/images/dark-background.jpg') !!}; background-position: 50% 7.2px;" data-stellar-background-ratio="0.4">
                    <div class="vertical-middle" style="position: absolute; top: 50%; width: 100%; margin-top: -125px;">
                        <div class="container clearfix">
