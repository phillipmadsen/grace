...
<article>
  ...
  <section id="content">
      ...
      <div class="content-wrap">
         <div class="container clearfix">
          ...
          <div class="row topmargin-sm clearfix">
              ...
              <a href="{!! url('/' . getLang()) !!}/machine-quilting/gq-frame/" class="button button-rounded button-secondary">Learn More</a>
      ...
      <a href="{!! url('/' . getLang()) !!}/machine-quilting/gracie-queen/" class="button button-rounded button-secondary">Learn More</a>
