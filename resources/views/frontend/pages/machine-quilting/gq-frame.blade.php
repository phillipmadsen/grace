    ...
    <div id="page-menu-wrap">
        <div class="container clearfix ">
            <nav class="one-page-menu">
                <ul>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-quilting/">Machine Quilting</a></li>
                    <li><a class="current" href="{!! URL::full(); !!}"><div>GQ Frame</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-quilting/gracie-king/"><div>Gracie King &amp; Queen</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-quilting/sr-2-frame"><div>SR-2 Frame</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-quilting/accessories/"><div>Acceccories</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-quilting/compare-machine-frames/"><div>Compare Frames</div></a></li>
                </ul>
            </nav>
            ...
            <div class="container clearfix">
                <div class="row clearfix">
                 <div class="heading-block topmargin center">
                    <h3>The GQ Machine Quilting Frame</h3>
                    <span class="before-heading">The top of the line quilting frame</span>
                </div>
...
<!--frames ============================-->
<a class="button button-full button-dark center tright bottommargin-sm" href="{!! url('/' . getLang()) !!}/machine-quilting/compare-machine-frames/">
    <div class="container clearfix">
...
<div class="container clearfix">
    ...
    <div class="row topmargin-sm clearfix">
     ...
     <div class="col_one_third">
         ...
         <a href="{!! url('/' . getLang()) !!}/machine-quilting/gracie-king/" class="button button-rounded button-secondary">Learn More</a>
         Or
         <a href="{!! url('/' . getLang()) !!}/machine-quilting/gq-frame/" class="button button-rounded">Buy Now</a>
