...
<section id="contact-page" class="container">
    <div class="row">
            ...
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <div class="control-group {!! $errors->has('sender_phone_number') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::text('sender_phone_number', null, array('class'=>'form-control', 'id' => 'sender_phone_number', 'placeholder'=>trans('grace.phone_number'), 'value'=>Input::old('sender_phone_number'))) !!}
        ...
        <!--/.col-sm-8-->
        <div class="col-sm-4">
            <h4>{!! trans('grace.our_location') !!}</h4>
