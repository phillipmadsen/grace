...
<html lang="{{ Config::get('app.locale') }}">
	...
	<body class="skin-blue">
        ...
        <script src="{!! asset('js/vendors/wizard/acc-wizard-master/js/acc-wizard.min.js') !!}"></script>

{!! Minify::javascript('/js/custom-admin/') !!}
{!! Minify::javascript('/js/liveicons/minified/raphael-min.js') !!}
{!! Minify::javascript('/js/liveicons/minified/livicons-1.4.min.js') !!}
