...
<div class="col_two_third">
                        ...
                        <div class="col_one_third">
                            ...
                            <div class="widget clearfix">
                                <img src="images/grace-logo-light.png" alt="" class="footer-logo">

                                 <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible Quilting</strong> Machines & Frame Standards.</p>
                        ...
                        <div class="col_one_third">
                            ...
                            <div class="widget widget_links clearfix">
                                ...
                                <div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
                                    ...
                                    <abbr title="Email Address"><strong>Email:</strong></abbr> info@graceframe.com
                                </div>
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2014 All Rights Reserved by The Grace Company.<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> info@grace.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> +1-800-264-0644 <span class="middot">&middot;</span> <i class="icon-skype2"></i> GraceOnSkype
					</div>
