    ...
    public function postForgotPassword() {
        ...
        try {
            ...
            Mail::send('emails.auth.reset-password', $formData, function ($message) {
                ...
                $message->from('noreply@graceadmin.com', 'Grace Manager Team');
                $message->to('user@graceadmin.com', 'Lorem Lipsum')->subject('Reset Password');
            });
            */
            /*
            $mailer = new Mailer;
            $mailer->send('emails.auth.reset-password', 'user@graceadmin.com', 'Reset Password', $formData);
            */
